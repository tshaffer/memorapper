...
export const parsePreview = async (sessionId: string, reviewText: string): Promise<ChatGPTOutput> => {
    ...
    reviewConversations[sessionId] = [
      {
        ...
        If any details are missing, still attempt to extract as much information as possible.
