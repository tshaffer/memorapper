...
import { deleteMrPlace, RootState, selectMrPlacesWithVisited, setCurrentMapLocation, setFilters } from '../../redux';
...
const MapPage: React.FC = () => {
  ...
  const mrPlacesWithGooglePlaces: (MrPlaceWithGooglePlace & { visited: boolean })[] =
    useSelector(selectMrPlacesWithVisited);
  ...
  const selectedPlace = useSelector((state: RootState) =>
    selectedPlaceId
      ? selectMrPlacesWithVisited(state).find(p => p._id === selectedPlaceId)
      : null
  );
